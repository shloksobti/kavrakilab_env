...
if [ -z "$1" ]
then
    echo "Usage: kavrakilab-create ros-pkg PACKAGE_NAME [ DEPENDENCY1 DEPENDENCY2 ... ]"
    return 1
fi

pkg_name=$1
pkg_dir=$KAVRAKILAB_ENV_DIR/sources/local/$pkg_name
...
echo '  <version>0.0.0</version>
  ...
  <maintainer email="todo@kavrakilab.rice">todo</maintainer>
